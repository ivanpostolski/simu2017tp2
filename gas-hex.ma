...
rule : {[6,(-1,-1)!1+1]} 1 {#macro(NoSoyBorde) and not #macro(VieneGasDeAbajo) and #macro(VieneGasDeIzquierda) and #macro(VieneGasDeArriba) and ( #macro(AtrasSincronizado) and (0,0)!1=-1) or (#macro(AtrasSincronizado) and #macro(AdelanteSincronizadoMasUno))}
